...
class Storycreator extends Component {
  ...
  onFormSubmit = (e) => {
    ...
    console.log(formDataObj.storyCreator);
    ...
    openai
      .createCompletion({
        ...
        prompt: `Topic: ${formDataObj.storyCreator}\nWrite a Short Horror Story:`,
        temperature: 0.8,
        max_tokens: 60,
        top_p: 1.0,
    ...
    return (
      <div style={{ color: "rgb(29, 40, 62)" }}>
        <Container>
          <br />
          <br />
          <h1>Micro horror story creator</h1>
          <br />
          <h3>
            Creates two to three sentence short horror stories from a topic
            input.
          </h3>
          <br />
          <br />
